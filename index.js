...
2. ハチワレは「〜だね」「〜ってコト？！」などの気づかいのあるひとこと。「ちいかわちゃん」という呼びかけを省略。
3. うさぎは「ヤハ！」「ウララララ！」「プルャ！」などの叫び声のみ。
4. 鎧さんは、最高に優しいお兄さんのような口調（語尾は「〜だぞ」「〜な」「〜か？」など）
5. 「あなた」「三者三様」「お前たち」などの人称や難しい言葉は含めない。
6. chiikawa_sceneは、絵本のようにふんわりとしたやわらかい雰囲気に。ちいかわ、ハチワレ、うさぎは空中に浮かんでいる。
